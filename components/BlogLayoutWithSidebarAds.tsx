  ...
  return (
    <div className="mt-10 flex flex-wrap items-center gap-3 border-t border-zinc-100 pt-6 px-4 sm:px-6 lg:px-8">
      ...
      <a
        ...
        className="inline-flex items-center gap-1.5 rounded-lg bg-[#1877F2] px-3 py-1.5 text-[12.5px] font-semibold text-white transition-opacity hover:opacity-80"
      >
        <svg className="h-3.5 w-3.5" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
      ...
      {/* Reddit */}
      <a
        href={`https://www.reddit.com/submit?url=${encodedUrl}&title=${title}`}
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Share on Reddit"
        className="inline-flex items-center gap-1.5 rounded-lg bg-[#FF4500] px-3 py-1.5 text-[12.5px] font-semibold text-white transition-opacity hover:opacity-80"
      >
        <svg className="h-3.5 w-3.5" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
