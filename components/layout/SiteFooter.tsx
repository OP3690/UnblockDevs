  ...
  return (
    <footer className="mt-auto border-t border-zinc-800/60 bg-zinc-950 text-zinc-400">
      <div className="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8 py-14 sm:py-16">
        ...
        {/* ── Mobile-only simplified footer (hidden on sm+) ───────────────── */}
        <div className="sm:hidden">
          ...
          <div className="mb-6">
            ...
            <p className="mb-4 max-w-[260px] text-[13px] leading-relaxed text-zinc-500">
              Free, privacy-first developer tools. Everything runs in your browser — no account, no data collection.
            </p>
          ...
          {/* Popular tools — condensed 2-col grid */}
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 gap-x-4 gap-y-2.5 text-[13px]">
              {[
                ...
                <Link key={l.href} href={l.href} className="text-zinc-500 transition-colors hover:text-zinc-200">
                  {l.label}
                </Link>
              ))}
            </div>
          ...
          {/* Company links */}
          <div className="mb-6 flex flex-wrap gap-x-5 gap-y-2.5 text-[13px]">
            {[
          ...
          {/* Mobile copyright */}
          <p className="text-[12px] text-zinc-600 border-t border-zinc-800/60 pt-5">
            © {new Date().getFullYear()} UnblockDevs. All tools are free and open to everyone.
          </p>
        </div>

        {/* ── Desktop full footer (hidden on mobile, visible sm+) ─────────── */}
