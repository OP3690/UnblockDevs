...
// LinkedIn Icons - Same square icon for top and bottom
const LinkedInIconTop = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122.88 122.31" className={className}>
    <defs>
      <style>{'.linkedin-top-cls-1{fill:#0a66c2;}.linkedin-top-cls-1,.linkedin-top-cls-2{fill-rule:evenodd;}.linkedin-top-cls-2{fill:#fff;}'}</style>
    </defs>
    <path className="linkedin-top-cls-1" d="M27.75,0H95.13a27.83,27.83,0,0,1,27.75,27.75V94.57a27.83,27.83,0,0,1-27.75,27.74H27.75A27.83,27.83,0,0,1,0,94.57V27.75A27.83,27.83,0,0,1,27.75,0Z"/>
    <path className="linkedin-top-cls-2" d="M49.19,47.41H64.72v8h.22c2.17-3.88,7.45-8,15.34-8,16.39,0,19.42,10.2,19.42,23.47V98.94H83.51V74c0-5.71-.12-13.06-8.42-13.06s-9.72,6.21-9.72,12.65v25.4H49.19V47.41ZM40,31.79a8.42,8.42,0,1,1-8.42-8.42A8.43,8.43,0,0,1,40,31.79ZM23.18,47.41H40V98.94H23.18V47.41Z"/>
  </svg>
);
...
// X Icons - Same square icon for top and bottom
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <button
                ...
                className="hidden md:flex items-center justify-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 bg-[#0077B5] text-white rounded-lg hover:bg-[#006399] transition-all hover:scale-105 text-sm font-medium shadow-sm min-w-[44px]"
                aria-label="Share on LinkedIn"
              >
                <LinkedInIconTop className="w-5 h-5 flex-shrink-0" />
                <span className="hidden sm:inline">LinkedIn</span>
              </button>
              <button
                onClick={shareToX}
                className="hidden md:flex items-center justify-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 bg-black text-white rounded-lg hover:bg-gray-800 transition-all hover:scale-105 text-sm font-medium shadow-sm min-w-[44px]"
                aria-label="Share on X (Twitter)"
              >
                <XIconTop className="w-5 h-5 flex-shrink-0" />
