...
export const blogPosts: BlogPost[] = [
    {
      slug: 'how-to-securely-store-api-keys-nodejs-env-best-practices',
      title: 'How to Securely Store API Keys in Node.js (2026)',
      excerpt: 'Stop hardcoding API keys. Learn the secure way to store secrets in Node.js using .env files, environment variables, secret managers, and what never to do.',
      date: '2026-03-10',
      readTime: '11 min read',
      category: 'Node.js & Backend',
      keywords: ['securely store api keys nodejs', 'nodejs api key security', 'env file api keys', 'nodejs secrets management', 'api key best practices nodejs 2026'],
    },
    {
      slug: 'how-to-use-env-files-in-nextjs-nextpublic-explained',
      title: 'How to Use .env Files in Next.js (NEXT_PUBLIC_ Explained)',
      excerpt: 'Complete guide to .env files in Next.js — NEXT_PUBLIC_ prefix, .env.local, .env.production, server vs client env vars, TypeScript types.',
      date: '2026-03-12',
      readTime: '10 min read',
      category: 'Node.js & Backend',
      keywords: ['nextjs env files', 'NEXT_PUBLIC env variable', 'nextjs environment variables', 'next.js .env.local', 'nextjs server vs client env vars'],
    },
    {
      slug: 'manage-multiple-env-files-nodejs-development-staging-production',
      title: 'How to Manage Multiple .env Files for Dev, Staging & Production in Node.js',
      excerpt: 'Master .env.development, .env.staging, .env.production, and .env.local — how to switch environments and keep secrets safe across your entire pipeline.',
      date: '2026-03-14',
      readTime: '10 min read',
      category: 'Node.js & Backend',
      keywords: ['manage multiple env files nodejs', '.env.development .env.production', 'nodejs multiple environments', 'env file staging production', 'dotenv multiple environments'],
    },
    {
      slug: 'process-env-vs-dotenv-vs-config-files-nodejs-which-to-use',
      title: 'process.env vs dotenv vs config files in Node.js — Which to Use?',
      excerpt: 'Compare process.env, dotenv, dotenv-flow, node-config, and convict for managing configuration in Node.js. Understand the tradeoffs and pick the right tool.',
      date: '2026-03-16',
      readTime: '12 min read',
      category: 'Node.js & Backend',
      keywords: ['process.env vs dotenv', 'nodejs config management', 'dotenv vs node-config', 'nodejs environment configuration', 'process.env vs config file nodejs'],
    },
    {
      slug: 'validate-environment-variables-nodejs-zod',
      title: 'How to Validate Environment Variables in Node.js with Zod',
      excerpt: 'Stop silent crashes from missing env vars. Use Zod to validate process.env at startup — TypeScript types, defaults, clear error messages.',
      date: '2026-03-18',
      readTime: '9 min read',
      category: 'Node.js & Backend',
      keywords: ['validate environment variables nodejs', 'zod env validation', 'nodejs process.env typescript', 'zod schema env vars', 'validate process.env at startup'],
    },
    {
