...
export const metadata: Metadata = {
  title: 'Free JSON Schema Generator — Draft 7 & OpenAPI | UnblockDevs',
  description:
    'Generate JSON Schema from sample JSON instantly. Supports Draft 7 and OpenAPI 3.0 formats. Built-in validator, smart type detection, 100% browser-based — no signup.',
  keywords: [
  ...
  openGraph: {
    title: 'Free JSON Schema Generator — Auto-Generate Draft 7 & OpenAPI Schemas Online | UnblockDevs',
    description:
      'Paste sample JSON and get a complete JSON Schema instantly. Supports Draft 7 and OpenAPI 3.0. Built-in validator, smart type detection, 100% browser-based — nothing uploaded.',
    type: 'website',
    url: canonicalUrl,
  ...
  twitter: {
    ...
    title: 'Free JSON Schema Generator — Draft 7 & OpenAPI Online',
    description: 'Paste JSON, get a complete Draft 7 or OpenAPI schema instantly. Validate JSON against it in your browser. 100% client-side, nothing uploaded.',
  },
