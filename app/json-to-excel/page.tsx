...
export const metadata: Metadata = {
  title: 'Free JSON to Excel Converter — XLSX & CSV Online | UnblockDevs',
  description:
    'Convert JSON to Excel (XLSX) or CSV online. Paste, upload, or fetch from API URL. Flatten nested objects, export to multiple sheets. Free, browser-based.',
  keywords: [
    'json to excel',
    'json to xlsx',
    'json to csv online',
  ...
  openGraph: {
    title:
      'Free JSON to Excel & CSV Converter — Flatten Nested JSON, Multi-Sheet Export | UnblockDevs',
    description:
      'Convert JSON to Excel or CSV in your browser. Paste, upload, or pull from an API URL. Flattens nested objects, supports multi-sheet export and column filters. Free, no signup required.',
    type: 'website',
    url: canonicalUrl,
  ...
  twitter: {
    ...
    title: 'Free JSON to Excel Converter — XLSX & CSV Online',
    description:
      'Paste JSON, upload a file, or fetch from API. Flatten nested JSON and export to XLSX or CSV with multi-sheet support. Free, browser-based.',
  },
