        ...
        <div className="bg-white rounded-xl shadow-lg p-8 md:p-12">
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8 bg-blue-50 border-l-4 border-blue-500 p-5 rounded-r-lg">
              <h2 className="text-xl font-bold text-gray-900 mb-3">Ezoic-Specific Information</h2>
              <p className="text-gray-700 mb-3 leading-relaxed text-sm">
                This website uses Ezoic to provide advertising services. Ezoic's privacy policy and data practices are governed by their own privacy policy. For more information about how Ezoic collects and uses data, please visit:
              </p>
              ...
              <p className="text-gray-700 leading-relaxed text-sm">
                Ezoic may use cookies, web beacons, and similar technologies to collect information about your visits to this and other websites to provide personalized advertisements and improve user experience.
              </p>
            </section>
          </div>
        </div>
