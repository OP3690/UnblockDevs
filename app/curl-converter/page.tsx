...
export const metadata: Metadata = {
  title: 'cURL Converter Free — Convert to Python, JS & Go | UnblockDevs',
  description: 'Convert cURL to Python, JavaScript fetch, Go, Java, PHP, or Rust in one click. Handles auth, headers, cookies, JSON body. Free — 100% browser-based.',
  keywords: [
    'curl to python',
    'curl to javascript',
    'curl to fetch',
  ...
  openGraph: {
    title: 'Free cURL Converter — Convert cURL to Python, JavaScript, Go, Java, PHP & More | UnblockDevs',
    description: 'Convert cURL commands to Python requests, JavaScript fetch/Axios, Go, Java, PHP, or Rust in one click. Handles auth, headers, cookies, and JSON body. 100% browser-based, API keys never leave.',
    type: 'website',
    url: canonicalUrl,
  ...
  twitter: {
    ...
    title: 'cURL Converter Free — Convert to Python, JavaScript, Go & More',
    description: 'Convert cURL to Python, JavaScript, Go, Java, PHP and more. Handles auth, headers, JSON body. 100% client-side — nothing uploaded.',
  },
