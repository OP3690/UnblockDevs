...
export const metadata: Metadata = {
  title: 'API Comparator Free — Diff JSON Responses Online | UnblockDevs',
  description:
    'Compare two API responses side-by-side with semantic JSON diff. Detect breaking changes, added or removed fields, and type changes. Free, 100% browser-based.',
  keywords: [
  ...
  openGraph: {
    title: 'Free API Comparator — Compare API Responses & Detect Breaking Changes Online | UnblockDevs',
    description: 'Semantic diff two API JSON responses to detect breaking changes, added or removed fields, and type changes. Paste responses and see results instantly. Free, 100% browser-based.',
    type: 'website',
    url: canonicalUrl,
    images: [{ url: 'https://unblockdevs.com/api/og?title=API%20Comparator%20%E2%80%94%20Diff%20API%20Responses%20Online&emoji=%E2%9A%97%EF%B8%8F&desc=Semantic%20diff%20two%20API%20JSON%20responses', width: 1200, height: 630, alt: 'API Comparator — Diff API Responses Online — UnblockDevs' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'API Comparator — Compare API Responses & Detect Breaking Changes',
    description: 'Semantic diff two API JSON responses to detect breaking changes, added/removed fields, type changes. Free, 100% browser-based, nothing uploaded.',
  },
