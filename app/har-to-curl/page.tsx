...
export const metadata: Metadata = {
  title: 'HAR to cURL Converter — Convert .har Files Free | UnblockDevs',
  description:
    'Convert .har files to cURL, Python, Go, and Java commands in seconds. Upload from Chrome, Firefox, or Edge DevTools. Mask secrets, export batch scripts. Free, 100% browser-based.',
  keywords: [
    'har to curl',
    'har to curl converter',
    'convert har file to curl',
    'har file parser online',
    'har to curl online free',
    'extract curl from har',
    'chrome devtools har to curl',
  ...
  openGraph: {
    title: 'Free HAR to cURL Converter — All Browser Requests, Multi-Language & Private | UnblockDevs',
    description:
      'Convert an entire .har file to cURL, Python, Go, Java, and more. Upload from Chrome, Firefox, or Edge DevTools. Mask secrets, batch export. 100% client-side, nothing ever uploaded to a server.',
    type: 'website',
    url: canonicalUrl,
  ...
  twitter: {
    ...
    title: 'HAR to cURL Converter — Convert .har Files Free Online',
    description:
      'Convert any .har file to cURL, Python, Go, or Java in seconds. Mask secrets, batch export scripts. No uploads — everything runs in your browser.',
  },
