...
export const metadata: Metadata = {
  title: 'Free JSON Fixer — Auto-Repair Malformed JSON Online | UnblockDevs',
  description: 'Fix invalid JSON automatically. Repairs trailing commas, single quotes, unquoted keys, and unexpected tokens. Free online JSON fixer — 100% client-side.',
  keywords: [
    'json fixer online',
    'fix invalid json',
    'json repair tool',
  ...
  openGraph: {
    title: 'Free JSON Fixer Online — Auto-Repair Invalid JSON Instantly | UnblockDevs',
    description: 'Paste broken JSON and get a valid, fixed result instantly. Repairs trailing commas, single quotes, unquoted keys, missing brackets, and AI-generated JSON errors. 100% client-side.',
    type: 'website',
    url: canonicalUrl,
  ...
  twitter: {
    ...
    title: 'Free JSON Fixer — Auto-Repair Invalid JSON Online',
    description: 'Paste broken JSON and get a valid result instantly. Repairs trailing commas, single quotes, unquoted keys, and AI JSON errors. 100% client-side.',
  },
