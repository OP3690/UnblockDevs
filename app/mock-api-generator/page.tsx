...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'mock json data',
    'generate mock data',
    'mock api generator free',
    'mock server',
    'json mock server',
    'fake endpoint generator',
    'rest api mock tool',
    'api simulator',
    'mock api no signup',
    'mock api browser',
    ...
    'http mock server',
    'api stub generator',
    'api fake response generator',
    'mock 404 response',
    'mock 500 error response',
    'simulate api latency',
    'simulate api rate limit',
    'mock auth api',
    'mock bearer token api',
    'mock api key authentication',
    'fake api for development',
    'prototype api',
    'offline api development',
    'mock rest endpoints',
    'mock api generator javascript',
    'mock api react testing',
    'mock api cypress testing',
    ...
    'api mock server free',
    'api mock tool online',
    'json mock response generator',
    'fake api endpoint',
    'mock api no code',
    'build mock api online',
  ],
  openGraph: {
