...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'Fix "fetch is not defined", CORS errors, 404s, and JSON parse failures in the Fetch API. Complete debugging guide with code examples for all 8 common Fetch issues.',
    type: 'website',
  ...
  twitter: {
    ...
    description: 'Fix "fetch is not defined", CORS errors, 404s, and JSON parse failures in the Fetch API. Covers missing await, wrong Content-Type, and Node.js compatibility.',
  },
