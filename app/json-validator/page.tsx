...
export const metadata: Metadata = {
  title: 'Free JSON Validator — Check Syntax & Schema Online | UnblockDevs',
  description:
    'Free JSON Validator: check syntax instantly and validate against JSON Schema (Draft 7, 2020-12). Exact error lines, AJV-compatible, 100% client-side — nothing uploaded.',
  keywords: [
  ...
  openGraph: {
    title: 'Free JSON Validator Online — Syntax & Schema Checker, Private, No Signup | UnblockDevs',
    description:
      'Validate JSON syntax instantly with exact error line numbers. Validate against JSON Schema (Draft 7, 2019-09, 2020-12). AJV-compatible, 100% browser-based — your JSON never leaves your device.',
    type: 'website',
    url: canonicalUrl,
  ...
  twitter: {
    ...
    title: 'Free JSON Validator — Syntax & Schema Checker Online',
    description: 'Validate JSON syntax and JSON Schema instantly. Draft 7 & 2020-12 supported. AJV-compatible. Exact error lines. 100% browser-based, private.',
  },
