...
export const metadata: Metadata = {
  title: 'Free Image to Base64 Converter — PNG JPG SVG | UnblockDevs',
  description:
    'Convert PNG, JPG, SVG, GIF, or WebP images to Base64. Get data URI, CSS background-image, HTML img src, and raw base64 string. Free, 100% browser-based.',
  keywords: [
  ...
  openGraph: {
    title: 'Free Image to Base64 Converter — PNG, JPG, SVG, GIF, WebP | UnblockDevs',
    description: 'Convert images to Base64 data URIs instantly. Get CSS background-image, HTML img src, and raw base64 string. Free, 100% browser-based, nothing uploaded.',
    type: 'website',
    url: canonicalUrl,
  ...
  twitter: {
    ...
    title: 'Free Image to Base64 Converter — PNG, JPG, SVG Online',
    description: 'Upload any image, get instant Base64 data URI, CSS background-image, and img src. 100% client-side. Free, nothing uploaded.',
  },
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'Why does my Base64 image make the page load slowly?', acceptedAnswer: { '@type': 'Answer', text: 'Base64 encoding increases image size by approximately 33%, and large Base64 strings embedded in HTML or CSS block the browser from parsing the rest of the document. If your image is larger than 10–20 KB, serve it as an external file instead. Reserve Base64 embedding for small icons and critical inline images where eliminating one HTTP request is worth the size penalty.' } },
    ...
    <>
      ...
      <ToolSEOContent>
        ...
        <SEOSection id="faq" eyebrow="FAQ" heading="Frequently Asked Questions">
          <FAQ items={[
            { q: 'Why is my Base64 image not displaying in HTML or CSS?', a: 'A Base64 image will not display if the data URI is missing the correct prefix. For an img tag, the src must be data:image/png;base64,[encoded] — with the correct MIME type (image/png, image/jpeg, image/svg+xml, etc.). For CSS background-image, wrap it in url("data:image/png;base64,[encoded]"). Also check that the Base64 string is not truncated — even one missing character will produce a broken image.' },
            ...
            { q: 'Why does my Base64 image make the page load slowly?', a: 'Base64 encoding increases image size by approximately 33%, and large Base64 strings embedded in HTML or CSS block the browser from parsing the rest of the document. If your image is larger than 10–20 KB, serve it as an external file instead. Reserve Base64 embedding for small icons and critical inline images where eliminating one HTTP request is worth the size penalty.' },
