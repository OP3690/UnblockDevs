...
import {
  ...
  Hash, Key, KeyRound, Layers, Link2, Lock, Package, Palette, Regex, Scissors,
...
const TOOL_ICON_MAP: Record<string, LucideIcon> = {
  ...
  AlignLeft, Regex, Grid3x3, Gauge, Clock, FileText, Palette, Timer, Square, LayoutGrid,
};
