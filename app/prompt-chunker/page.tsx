...
export const metadata: Metadata = {
  title: 'Free Prompt Chunker — Split Text for AI Windows | UnblockDevs',
  description:
    'Split long prompts into chunks with smart overlap for ChatGPT, Claude, and Gemini. Auto-adds consolidation instructions. Token counter included. Free.',
  keywords: [
    'prompt chunker',
    'ai prompt splitter',
  ...
  openGraph: {
    ...
    description:
      'Split long prompts into context-window-sized chunks with smart overlap for ChatGPT, Claude, and Gemini. Auto-adds consolidation instructions and shows token counts per chunk. Free, no signup.',
    type: 'website',
    url: canonicalUrl,
  ...
  twitter: {
    ...
    title: 'Prompt Chunker — Split Text for AI Context Windows',
    description: 'Split long prompts into chunks with overlap for ChatGPT, Claude, and Gemini. Auto consolidation instructions, token counter included. Free.',
  },
  alternates: {
