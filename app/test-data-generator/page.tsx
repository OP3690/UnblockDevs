...
export const metadata: Metadata = {
  title: 'Free Test Data Generator — Fake JSON & CSV Online | UnblockDevs',
  description:
    'Generate realistic test data instantly — users, invoices, banking, API logs, and more. Choose from 11 templates or define custom JSON Schema. Free, no signup.',
  keywords: [
    'test data generator',
    'fake data generator',
    'mock data generator',
  ...
  openGraph: {
    title:
      'Free Test Data Generator — 11 Templates, Custom JSON Schema & Bulk Export | UnblockDevs',
    description:
      'Generate realistic fake data with 11 built-in templates — users, invoices, banking, API logs, security events, AI training data. Or define your own JSON Schema. Export CSV or JSON. Free, no signup.',
    type: 'website',
    url: canonicalUrl,
  ...
  twitter: {
    ...
    title: 'Free Test Data Generator — Fake JSON & CSV Online',
    description:
      '11 templates or custom JSON Schema. Users, invoices, banking, API logs, AI training data. Export JSON or CSV. Free, browser-based.',
  },
