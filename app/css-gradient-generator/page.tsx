...
export const metadata: Metadata = {
  title: 'CSS Gradient Generator — Linear, Radial & Conic Free | UnblockDevs',
  description:
    'Free CSS gradient generator with live preview. Create linear, radial, and conic gradients with drag-and-drop color stops. Copy CSS and Tailwind code instantly. 20+ presets.',
  keywords: [
  ...
  openGraph: {
    title: 'Free CSS Gradient Generator — Linear, Radial & Conic with Live Preview | UnblockDevs',
    description: 'Create linear, radial, and conic CSS gradients with drag-and-drop color stops and live preview. Copy CSS or Tailwind code instantly. 20+ gradient presets included.',
    type: 'website',
    url: canonicalUrl,
  ...
  twitter: {
    ...
    title: 'CSS Gradient Generator — Linear, Radial & Conic Free Online',
    description: 'Linear, radial, and conic gradients with live preview. Drag-and-drop color stops. Copy CSS + Tailwind code. 20+ presets.',
  },
...
const faqSchema = {
  ...
  '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: 'Why does my CSS gradient look different in Firefox than Chrome?', acceptedAnswer: { '@type': 'Answer', text: 'Color interpolation differences and gamma correction handling can cause gradients to appear slightly different across browsers, especially through midpoints. To get consistent results, add an explicit midpoint color stop, use the "in srgb" or "in oklch" color interpolation hint if supported, and test the final CSS in all target browsers. The generator outputs standard CSS that works in all modern browsers.' } },
    ...
    { '@type': 'Question', name: 'When should I use a radial gradient instead of a linear gradient?', acceptedAnswer: { '@type': 'Answer', text: 'Use a radial gradient when you want light or color to radiate from a focal point — spotlight effects, vignettes, radial glows, or circular UI elements. Use linear gradients for directional effects: hero background fades, button fills, or progress bars. Conic gradients work best for pie-chart-style designs or angular color sweeps around a center.' } },
    { '@type': 'Question', name: 'How do I use the CSS gradient output in Tailwind CSS?', acceptedAnswer: { '@type': 'Answer', text: 'This generator outputs both CSS and Tailwind formats. For Tailwind, use the direction + color utilities: bg-gradient-to-r from-violet-500 to-blue-500. For custom gradients not in Tailwind\'s palette, use arbitrary values: bg-[linear-gradient(135deg,#667eea_0%,#764ba2_100%)]. Click the Tailwind tab in the generator to get the ready-to-use class string for your project.' } },
  ],
};
    ...
    <>
      ...
      <ToolSEOContent>
        ...
        <SEOSection id="faq" eyebrow="FAQ" heading="Frequently Asked Questions">
          <FAQ items={[
            { q: 'Why does my CSS gradient look different in Firefox than Chrome?', a: 'Color interpolation differences and gamma correction can cause gradients to appear slightly different across browsers, especially at midpoints. Add an explicit midpoint color stop to get more consistent results, and test the final CSS in all target browsers before shipping.' },
            ...
            { q: 'When should I use a radial gradient instead of a linear gradient?', a: 'Use radial gradients when color should radiate from a focal point — spotlight effects, vignettes, or radial glows. Use linear gradients for directional effects: hero background fades, button fills, or progress bars. Conic gradients work best for pie-chart-style or angular color sweep designs.' },
            { q: 'How do I use the CSS gradient output in Tailwind CSS?', a: <>This generator outputs both CSS and Tailwind formats. Use <C>bg-gradient-to-r from-violet-500 to-blue-500</C> for built-in colors, or arbitrary values like <C>bg-[linear-gradient(135deg,#667eea_0%,#764ba2_100%)]</C> for custom gradients. Click the Tailwind tab to get the ready-to-use class string.</> },
          ]} />
        </SEOSection>
