...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    description: 'Complete reference for JSON escape sequences. Fix backslash, newline, double-quote, and Unicode escape errors in API payloads and config files.',
  },
