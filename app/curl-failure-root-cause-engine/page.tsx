...
export const metadata: Metadata = {
  title: 'cURL Failure Root-Cause Engine — Debug API Errors | UnblockDevs',
  description:
    'Paste your failed cURL command and HTTP status code. Get ranked root causes, fix suggestions, and corrected cURL commands instantly. Free, 100% browser-based.',
  keywords: [
    'curl error debugger',
  ...
  openGraph: {
    title: 'cURL Failure Root-Cause Engine — Debug API Errors, Fix 401 400 403 404 | UnblockDevs',
    description:
      'Paste your failed cURL command and HTTP status code. Get ranked root causes with confidence scores, fix suggestions, and corrected cURL commands. Free, 100% in your browser.',
    type: 'website',
    url: canonicalUrl,
  ...
  twitter: {
    ...
    title: 'cURL Failure Root-Cause Engine — Debug API Errors & Fix 401 400 404',
    description: 'Ranked root causes, confidence scores, and corrected cURL commands for failed API calls. Free, 100% browser-based, nothing sent.',
  },
