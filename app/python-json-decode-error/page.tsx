...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    description: 'Fix Python json.loads() JSONDecodeError — handle HTML responses, BOM characters, empty strings, trailing commas, and encoding issues with safe parsing patterns.',
  },
