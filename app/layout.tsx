...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'json-schema-generator',
    'unblockdevs.com',
    // UnblockDevs brand keyword combinations for better search visibility
    'unblock devs json',
    'unblock devs mysql',
    'unblock devs ai',
    'unblock devs api',
    ...
    // Frequently searched error messages and fixes
    ...
    // cURL related frequently searched terms
    'curl error fix',
    ...
    'curl debug',
    'curl fix error',
    'curl header generator',
    'curl json post example',
    'curl authentication',
    'curl bearer token',
    // API testing frequently searched
    'api test online',
    'api tester free',
    'rest api tester',
    'api debug tool',
    ...
    // Developer tools frequently searched
    ...
    'log json parser',
    // Timezone and date
    'json timezone converter',
    'convert timezone json',
    'timezone translator',
    // Token comparison
    'compare jwt tokens',
