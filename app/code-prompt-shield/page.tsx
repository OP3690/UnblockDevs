...
export const metadata: Metadata = {
  title: 'Free Code Prompt Shield — Mask API Keys Before AI | UnblockDevs',
  description:
    'Mask API keys, secrets, and PII in your code before sending to ChatGPT, Claude, or Copilot. 18 languages, fully reversible. Free, 100% browser-based.',
  keywords: [
    'mask code before chatgpt',
    'hide api keys from chatgpt',
    'code privacy chatgpt',
    'mask api keys before ai',
  ...
  twitter: {
    ...
    title: 'Code Prompt Shield — Mask API Keys Before ChatGPT',
    description: 'Mask API keys, secrets, and PII in code before ChatGPT, Claude, or Copilot. 18 languages supported, fully reversible. Free, browser-based.',
  },
