...
export const metadata: Metadata = {
  title: 'Free JSON Formatter — Pretty-Print & Validate Online | UnblockDevs',
  description:
    'Free JSON formatter online. Paste JSON and get clean indented output — 2 or 4 spaces or tab. Validates syntax and highlights errors. 100% browser, no signup.',
  keywords: [
    'json formatter',
  ...
  openGraph: {
    ...
    description:
      'Format, validate, and beautify JSON instantly. Paste minified JSON and get clean, 2-space, 4-space, or tab-indented output. Validates syntax and highlights errors. 100% client-side, no signup.',
    type: 'website',
    url: canonicalUrl,
  ...
  twitter: {
    ...
    title: 'JSON Formatter Online — Free & Private',
    description: 'Paste minified JSON and get clean indented output instantly. Validates syntax, highlights errors. 100% client-side, nothing sent to any server.',
  },
