...
export const metadata: Metadata = {
  title: 'Free Password Strength Checker — Audit & HIBP | UnblockDevs',
  description:
    'Audit any password for strength, entropy, crack time, and HIBP breach status. Detect patterns, build policies, export code. Free, 100% browser-based.',
  keywords: [
    ...
    'password crack time',
    'password checker free',
    'nist password guidelines',
    'password pattern detection',
  ],
  openGraph: {
    title: 'Free Password Strength Checker — Entropy, HIBP Breach Status & Policy Builder | UnblockDevs',
    description: 'Check password strength, entropy, crack time, and HIBP breach status. Detect keyboard walks and patterns. Build policies with live regex and export code. 100% browser-based, no signup.',
    type: 'website',
    url: canonicalUrl,
  ...
  twitter: {
    ...
    title: 'Free Password Strength Checker — Audit & HIBP Check',
    description: 'Check password entropy, crack time estimates, and HIBP breach status. Detect weak patterns and build policies. Free, 100% browser-based.',
  },
