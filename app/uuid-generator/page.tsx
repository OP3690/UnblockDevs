...
export const metadata: Metadata = {
  title: 'Free UUID Generator — v1–v8, Bulk & Validate Online | UnblockDevs',
  description:
    'Generate UUIDs for all versions v1–v8 online. Bulk generate up to 1,000, validate, analyze, and export to JSON, CSV, or SQL INSERT. Free, browser-based.',
  keywords: [
    ...
    'uuid v1 v4 v7 difference',
    'uuid v7 sortable',
    'crypto.randomUUID',
  ],
  openGraph: {
    title: 'UUID / GUID Generator — v1–v8, Validate, Bulk Export | UnblockDevs',
    description: 'Generate RFC 4122 UUIDs for v1–v8. Bulk generate up to 1,000, validate, analyze version and timestamp, and export to JSON, CSV, or SQL INSERT. Free, 100% browser-based.',
    type: 'website',
    url: canonicalUrl,
  ...
  twitter: {
    ...
    title: 'Free UUID Generator — v1–v8, Bulk & Validate Online',
    description: 'Generate UUIDs for all versions v1–v8, validate format, analyze, and export to JSON, CSV, or SQL INSERT. Bulk up to 1,000. Free, browser-based.',
  },
