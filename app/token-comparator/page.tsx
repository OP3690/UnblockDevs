...
export const metadata: Metadata = {
  title: 'Free JWT Debugger & Token Comparator — Decode | UnblockDevs',
  description:
    'Decode and compare JWT tokens online. Run security audits, check expiration, detect vulnerabilities, and analyze entropy. Free, 100% browser-based.',
  keywords: [
    'jwt debugger online',
    'token comparator',
    'jwt decoder online',
  ...
  openGraph: {
    ...
    description:
      'Decode JWT tokens, compare them character-by-character, run security audits for known vulnerabilities, check expiration, and analyze entropy. Free, 100% browser-based. Nothing sent to servers.',
    type: 'website',
    url: canonicalUrl,
  ...
  twitter: {
    ...
    title: 'JWT Debugger & Token Comparator — Decode & Audit',
    description: 'Decode JWT tokens, compare character-by-character, audit for vulnerabilities, and check expiry. Free, 100% browser-based, nothing sent to servers.',
  },
