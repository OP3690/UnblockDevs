...
export const metadata: Metadata = {
  title: 'Free cURL to Python Requests Converter Online | UnblockDevs',
  description: 'Convert cURL commands to Python Requests code instantly. Handles GET, POST, headers, auth, and JSON bodies. Free, no signup. Paste curl, get Python.',
  keywords: [
  ...
  openGraph: {
    title: 'Free cURL to Python Requests Converter Online | UnblockDevs',
    description: 'Convert cURL commands to Python Requests code instantly. Handles GET, POST, headers, authentication, JSON bodies, and cookies. Free online tool, no signup, works in your browser.',
    type: 'website',
  ...
  twitter: {
    ...
    description: 'Convert cURL commands to Python Requests code instantly. Handles headers, auth, POST body, cookies, and JSON. Free, browser-based, no signup needed.',
  },
