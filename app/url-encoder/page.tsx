...
export const metadata: Metadata = {
  title:
    'Free URL Encoder Decoder — Percent-Encode Online | UnblockDevs',
  description:
    'Encode or decode URLs in RFC 3986, form-urlencoded, or encodeURIComponent. Parse query parameters, detect double encoding. Free, 100% browser-based.',
  keywords: [
    'url encoder online',
    'url decoder online',
  ...
  openGraph: {
    title: 'Free URL Encoder Decoder — RFC 3986, encodeURIComponent & Query Strings | UnblockDevs',
    description:
      'Encode/decode URLs in RFC 3986, form-urlencoded, encodeURI, encodeURIComponent. Parse URLs, edit query params, detect double encoding, run security checks. 100% browser-based.',
    type: 'website',
    url: canonicalUrl,
  ...
  twitter: {
    ...
    title: 'Free URL Encoder Decoder — Percent-Encode, Parse Params, Fix Double Encoding',
    description: 'Encode/decode URLs in RFC 3986 or encodeURIComponent. Parse query params, detect double encoding. Free, 100% in your browser.',
  },
