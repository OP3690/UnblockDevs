...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: 'process.env Not Working in Node.js? 6 Fixes | UnblockDevs',
    description: 'Fix process.env returning undefined in Node.js, Next.js, and Vite. Covers dotenv setup, NEXT_PUBLIC_ prefix, Vercel env vars, and TypeScript issues.',
  },
