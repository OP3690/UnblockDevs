  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <main className="max-w-7xl mx-auto container-padding py-8 animate-fade-in">
        <h2 className="text-2xl font-bold text-gray-900 mb-6">JSON Tools & Developer Utilities</h2>
        {activeTab === 'converter' && (
          rows.length === 0 ? (
        ...
        <div className="max-w-7xl mx-auto container-padding">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              ...
              <a href="/blog/html-tags-explained-guide" className="text-blue-600 hover:text-blue-800 underline ml-1">
        ...
        <div className="max-w-7xl mx-auto container-padding text-center">
            <div className="space-y-2">
              ...
              <div className="mt-4 pt-4 border-t border-gray-200">
                <p className="text-xs text-gray-500 mb-2">Explore our resources:</p>
                <a href="/blog/html-tags-explained-guide" className="text-blue-600 hover:text-blue-800 text-xs underline mx-2">
                  HTML Tags Guide
                </a>
              </div>
            </div>
