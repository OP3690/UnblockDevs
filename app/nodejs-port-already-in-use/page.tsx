...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Fix "Port Already in Use" Error in Node.js | UnblockDevs',
    description: 'Fix EADDRINUSE: address already in use error in Node.js. Kill the process on any port on Mac, Linux, and Windows using lsof, taskkill, fuser, or npx kill-port.',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Fix "Port Already in Use" Error in Node.js | UnblockDevs',
    description: 'Fix EADDRINUSE: address already in use error in Node.js. Kill processes on Mac, Linux, and Windows using lsof, taskkill, or npx kill-port.',
  },
