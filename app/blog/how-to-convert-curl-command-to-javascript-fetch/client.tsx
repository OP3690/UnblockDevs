...
import { ArrowLeft, Code, ArrowRightLeft, CheckCircle, AlertCircle, HelpCircle, Clock, Globe, Key } from 'lucide-react';
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
                ...
                <p className="text-gray-700 text-sm mb-2">Common mappings: <code className="bg-gray-100 px-1 rounded">-X GET</code> → <code className="bg-gray-100 px-1 rounded">method: "GET"</code>, <code className="bg-gray-100 px-1 rounded">-H "Key: Value"</code> → <code className="bg-gray-100 px-1 rounded">headers object with Key: Value</code>, <code className="bg-gray-100 px-1 rounded">-d 'data'</code> → <code className="bg-gray-100 px-1 rounded">body: "data"</code>, <code className="bg-gray-100 px-1 rounded">-u user:pass</code> → <code className="bg-gray-100 px-1 rounded">headers with Authorization: Basic</code>.</p>
            ...
            <div className="space-y-3">
              <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
                ...
                <div className="bg-gray-900 text-gray-100 p-3 rounded-lg overflow-x-auto mb-2">
                  <pre className="text-sm"><code>{`curl -X GET    → method: 'GET'
curl -X POST   → method: 'POST'
curl -X PUT    → method: 'PUT'
curl -X DELETE → method: 'DELETE'
curl -X PATCH  → method: 'PATCH'`}</code></pre>
                </div>
              </div>
              <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
                <h3 className="font-semibold text-gray-900 mb-2">Headers</h3>
                <div className="bg-gray-900 text-gray-100 p-3 rounded-lg overflow-x-auto mb-2">
                  <pre className="text-sm"><code>{`curl -H "Header: Value" → headers object with Header: Value
curl -H "Content-Type: application/json"
     → headers object with Content-Type: application/json`}</code></pre>
                </div>
              </div>
              <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
                <h3 className="font-semibold text-gray-900 mb-2">Data/Body</h3>
                <div className="bg-gray-900 text-gray-100 p-3 rounded-lg overflow-x-auto mb-2">
                  <pre className="text-sm"><code>{`curl -d with JSON data → body: JSON.stringify(data)
curl -d "key=value"        → body: 'key=value' (form data)
curl --data-raw 'data'     → body: 'data'`}</code></pre>
                </div>
              </div>
              <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
...
curl -u user:pass
     → headers object with Authorization: Basic + btoa`}</code></pre>
                </div>
              </div>
            </div>
          </section>
