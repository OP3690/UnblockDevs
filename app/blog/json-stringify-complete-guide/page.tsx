...
export const metadata: Metadata = {
  title: 'JSON.stringify() Complete Guide: Options & Examples | UnblockDevs',
  description:
    'Master JSON.stringify(): all three parameters, pretty-print vs compact output, replacer for field filtering, toJSON(), and common mistakes with fixes.',
  keywords: [
    'json stringify',
  ...
  twitter: {
    ...
    title: 'JSON.stringify() Complete Guide: Options & Examples',
    description:
      'Three parameters, pretty-print, replacer for filtering, toJSON(), and common mistakes — everything about JSON.stringify() in one guide.',
  },
