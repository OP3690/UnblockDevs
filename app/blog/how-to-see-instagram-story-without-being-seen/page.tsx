...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'instagram story without showing up',
    'how to see instagram story without being seen',
    'view instagram story privately',
    'instagram anonymous story viewer',
    'see instagram story without appearing',
    'instagram story viewer anonymous',
    'how to view instagram story anonymously',
    'instagram story without seen',
    'view instagram story incognito',
    'instagram story private viewer',
    'see instagram story without showing',
    'anonymous instagram story viewer',
    'instagram story viewing without seen'
  ],
  openGraph: {
...
export default function HowToSeeInstagramStoryWithoutBeingSeenGuide() {
  return <HowToSeeInstagramStoryWithoutBeingSeenClient />;
}
