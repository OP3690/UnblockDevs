...
export const metadata: Metadata = {
  ...
  description: 'Complete guide to MySQL 10 most used functions: COUNT, SUM, AVG, MAX, MIN, CONCAT, SUBSTRING, DATE_FORMAT, IF, and CASE. Learn syntax, examples, and best practices for each function.',
  keywords: [
    'mysql functions',
