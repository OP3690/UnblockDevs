...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'signs someone blocked you instagram',
    'how to tell if blocked on instagram',
    'instagram block detection',
    'check instagram block',
    'know if blocked instagram',
    'instagram blocked check',
    'how to see if blocked on instagram',
    'instagram block signs',
    'detect instagram block',
    'check if instagram blocked',
    'instagram blocking detection',
    'know if someone blocked you instagram'
  ],
  openGraph: {
...
export default function HowToKnowIfSomeoneBlockedYouOnInstagramGuide() {
  return <HowToKnowIfSomeoneBlockedYouOnInstagramClient />;
}
