...
export const metadata: Metadata = {
  ...
  description: 'Complete guide to working with JSON in MySQL: JSON data types, structure, extracting data from JSON columns, nested JSON queries, 10 practical examples, and tips & tricks for efficient JSON manipulation.',
  keywords: [
    'mysql json',
    'mysql json extract',
