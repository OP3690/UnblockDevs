...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'how to change instagram phone number',
    'how to change instagram email',
    'change instagram contact info',
    'instagram phone number change 2026',
    'instagram email change guide',
    'update instagram phone number',
    'update instagram email address',
    'change instagram number step by step',
    'instagram account settings',
    'change instagram phone number android',
    'change instagram email iphone',
    'instagram contact information update',
...
export default function HowToChangeInstagramPhoneEmailGuide() {
  return <HowToChangeInstagramPhoneEmailClient />;
}
