...
export const metadata: Metadata = {
  title: 'Free Timezone Converter — World Clock & DST Online | UnblockDevs',
  description:
  ...
  keywords: [
    ...
    'how to convert timezone online',
    'timezone calculator free',
    'schedule meetings across timezones',
    'timezone tool developer',
  ],
  openGraph: {
    title: 'Free Timezone Converter — Convert Times Between UTC, EST, PST, IST & 500+ IANA Timezones | UnblockDevs',
    description:
      'Convert times between any two timezones instantly. Supports 500+ IANA zones including UTC, EST, PST, IST, JST, AEST, and CET. DST-aware, free, no signup required.',
    type: 'website',
    url: canonicalUrl,
  ...
  twitter: {
    ...
    title: 'Free Timezone Converter — World Clock & DST Online',
    description: 'Convert times between UTC, EST, PST, IST, and 500+ IANA timezones instantly. DST-aware and ready for scheduling across teams. 100% browser-based, no signup needed.',
  },
  alternates: {
