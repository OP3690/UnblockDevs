...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'svg to image browser',
    'svg to png without upload',
    'convert svg to png javascript',
    'canvas api svg to png',
    'svg to dataurl',
    'svg to base64 png',
    'svg to png react',
    'svg to png node.js',
    'inkscape svg to png alternative',
    'imagemagick svg to png alternative',
    'figma svg export alternative',
    'svg to png email',
    'svg to png slack',
    'svg to png twitter',
    'svg to png social media',
    'svg to png pdf',
    'svg to png favicon',
    'svg to png app icon',
    'svg to png ios icon',
    'svg to png android icon',
    'svg to jpg quality',
    'svg to jpeg quality',
    'svg to png background color',
    ...
    'svg to jpeg online converter',
    'convert svg graphic to png',
    'svg file to image',
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Select PNG as the output format (not JPEG) — PNG supports transparency natively. Make sure your SVG does not have a background fill, and the converter will preserve the transparent areas in the exported PNG. JPEG does not support transparency; it will fill transparent areas with white.',
      },
    },
    {
      '@type': 'Question',
      name: 'How do I export a high-resolution PNG from SVG?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Set the width and height to your target display size, then increase the scale multiplier. Set scale to 2 for a @2x Retina-ready image or 3 for @3x. The output pixel dimensions will be width × scale by height × scale, giving you a crisp high-DPI image from the lossless SVG source.',
      },
    },
    {
      '@type': 'Question',
      name: 'How do I convert SVG to PNG in JavaScript?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Create an HTMLImageElement, set its src to a data URL of the SVG (`"data:image/svg+xml," + encodeURIComponent(svgString)`), then draw it to a Canvas element and call `canvas.toDataURL("image/png")` to get the PNG. Libraries like sharp (Node.js) and canvg also handle SVG-to-PNG conversion server-side.',
      },
    },
    {
      '@type': 'Question',
    ...
    {
      '@type': 'Question',
      name: 'How do I convert an SVG to a PNG app icon?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Paste your SVG, set the width and height to the largest icon size needed (e.g., 1024×1024 for iOS), and export as PNG. For multiple sizes, repeat the export at each required resolution (512, 256, 192, 128, 64, 32px). The SVG source is lossless so each export will be crisp regardless of size.',
      },
    },
    {
      '@type': 'Question',
      name: 'Can I convert SVG to JPEG instead of PNG?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. Select JPEG as the output format before exporting. JPEG uses lossy compression producing smaller file sizes — useful for SVG illustrations with many colors. Note that JPEG does not support transparency; any transparent areas in your SVG will be filled with a white background in the JPEG output.',
      },
    },
    {
      '@type': 'Question',
      name: 'How do I convert SVG to PNG for use in email signatures?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Export your SVG as PNG at the size you want displayed in the email (e.g., 200×60px for a logo). Email clients like Outlook block SVG for security reasons but render PNG and JPEG reliably. Use a transparent-background PNG if your email template uses a colored or dark background.',
      },
    },
    {
      '@type': 'Question',
      name: 'Is SVG to PNG conversion lossless?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. SVG is a lossless vector format and PNG is a lossless raster format. Converting SVG to PNG at the same or larger pixel dimensions produces a pixel-perfect result with no quality degradation. Only converting to JPEG introduces lossy compression. For the highest-quality output, export at 2x or 3x the display size.',
      },
    },
    {
      '@type': 'Question',
      name: 'What is the maximum size I can export SVG as PNG?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'There is no hard limit — you can set any width and height in pixels. However, very large exports (e.g., 10000×10000px) may be constrained by your browser\'s canvas size limit (typically 16,384px on each dimension in Chrome). For most use cases, 2x or 3x the display size is sufficient for high-DPI screens.',
      },
    },
  ],
};
      ...
      <ToolSEOContent>
        ...
        <SEOSection id="faq" eyebrow="FAQ" heading="Frequently Asked Questions">
          <FAQ items={[
            ...
            {
              q: 'How do I convert SVG to PNG with a transparent background?',
              a: 'Select PNG as the output format — PNG supports transparency natively. Make sure your SVG has no background fill, and transparent areas will be preserved in the exported PNG. JPEG fills transparent areas with white.',
            },
            {
              q: 'How do I convert SVG to PNG in JavaScript?',
            ...
            },
            {
              ...
              a: 'Set the width and height to the largest icon size needed (e.g., 1024×1024 for iOS), export as PNG, then repeat at each required resolution (512, 256, 192, 128, 64, 32px). The SVG source is lossless so every export will be crisp.',
            },
            {
              q: 'Can I convert SVG to JPEG instead of PNG?',
              a: 'Yes. Select JPEG as the output format. JPEG uses lossy compression for smaller file sizes, good for SVG illustrations with many colors. Note that JPEG does not support transparency — transparent areas will be filled with white.',
            },
            {
              q: 'How do I convert SVG to PNG for email signatures?',
              a: 'Export your SVG as PNG at the display size you need (e.g., 200×60px for a logo). Email clients like Outlook block SVG for security but render PNG reliably. Use a transparent-background PNG if your email template has a colored background.',
            },
            {
              q: 'Is SVG to PNG conversion lossless?',
              a: 'Yes. SVG is a lossless vector format and PNG is a lossless raster format. Converting SVG to PNG at the same or larger pixel dimensions produces a pixel-perfect result with no quality degradation. Only converting to JPEG introduces lossy compression.',
            },
          ]} />
        </SEOSection>
