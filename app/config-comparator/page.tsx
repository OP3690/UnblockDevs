...
export const metadata: Metadata = {
  title: 'Free Config File Comparator — Diff Config Files | UnblockDevs',
  description:
    'Compare configuration files side by side — JSON, YAML, .env, TOML, and INI. Detect added, removed, and changed settings instantly. Free, browser-based.',
  keywords: [
    'config comparator',
  ...
  openGraph: {
    ...
    description: 'Compare any two config files side by side — JSON, YAML, .env, TOML, and INI formats. Detect added, removed, and changed settings at a glance. Free, 100% browser-based, nothing uploaded.',
    type: 'website',
    url: canonicalUrl,
  ...
  twitter: {
    ...
    title: 'Free Config File Comparator — Diff JSON, YAML, ENV, TOML',
    description: 'Compare config files side by side — JSON, YAML, .env, TOML, INI. Detect added, removed, and changed settings. Free, browser-based.',
  },
