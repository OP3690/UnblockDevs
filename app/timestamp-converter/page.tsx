...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'What is the Unix epoch (January 1, 1970)?', acceptedAnswer: { '@type': 'Answer', text: 'The Unix epoch is the reference point for Unix time: midnight at the start of January 1, 1970, in UTC (1970-01-01T00:00:00Z). Its Unix timestamp is 0. All Unix timestamps are the count of seconds (or milliseconds) elapsed since this moment, regardless of the timezone of the observer.' } },
      ...
      <ToolSEOContent>
        ...
        <SEOSection id="faq" eyebrow="FAQ" heading="Frequently Asked Questions">
          <FAQ items={[
            ...
            { q: 'What is the Unix epoch (January 1, 1970)?', a: 'The Unix epoch is midnight at the start of January 1, 1970, in UTC (1970-01-01T00:00:00Z), which has a Unix timestamp of 0. All Unix timestamps count the seconds elapsed from this fixed reference point, making them timezone-independent.' },
