...
export const metadata: Metadata = {
  ...
  keywords: [
    // Exact error message cluster — highest traffic
    'blocked by cors policy no access-control-allow-origin header is present',
    'has been blocked by cors policy',
    'no access-control-allow-origin header is present on the requested resource',
    'cors policy blocked request',
    'cors blocked fetch error',
    'access to fetch has been blocked by cors policy',
    'cross-origin request blocked',
    // Fix CORS error cluster
    'how to fix cors error',
    'fix cors error javascript',
    'fix cors error react',
    'fix cors error nextjs',
    'fix cors error express',
    'fix cors error fastapi',
    'fix cors error node js',
    'fix cors error axios',
    'cors error fix online',
    // Test & debug cluster
    'cors tester online',
