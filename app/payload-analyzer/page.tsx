...
export const metadata: Metadata = {
  title: 'Free Payload Analyzer — Debug HTTP Request Bodies | UnblockDevs',
  ...
  keywords: [
    ...
    'json payload size',
    'multipart payload analyzer',
    'api payload tool free',
    'payload debugging',
  ],
  openGraph: {
    title: 'Free Payload Analyzer — Debug HTTP Request Bodies, JSON, XML & Multipart | UnblockDevs',
    description: 'Analyze HTTP request bodies and API payloads instantly. Inspect JSON, form data, XML, and multipart. Detect payload size issues, validate structure, and debug 413 errors. Free, client-side.',
    type: 'website',
    url: canonicalUrl,
  ...
  twitter: {
    ...
    title: 'Free Payload Analyzer — Debug HTTP Request Bodies',
    description: 'Analyze HTTP request bodies instantly — JSON, form data, XML, and multipart. Debug payload size issues and 413 errors. Free, client-side.',
  },
      ...
      <ToolSEOContent>
        ...
        <SEOSection id="guides" eyebrow="Learn more" heading="Developer Guides">
          <RelatedBlogPosts posts={[
            { href: '/blog/top-10-json-errors-waste-developer-time', label: 'Top 10 JSON Payload Errors' },
            { href: '/blog/why-json-breaks-in-real-world-apis', label: 'Why API Payloads Break' },
            { href: '/blog/json-best-practices-production-guide', label: 'Payload Design Best Practices' },
            { href: '/blog/fix-json-errors-complete-guide', label: 'Fix Payload Parsing Errors' },
          ]} />
        </SEOSection>
      </ToolSEOContent>
