...
export const metadata: Metadata = {
  title: 'Free JSON Beautifier & Formatter — View, Validate & Explore | UnblockDevs',
  description:
    'Free JSON Beautifier online. Format, validate, auto-fix, and explore JSON with tree view, JSONPath, TypeScript generator, and SQL export. 100% client-side — nothing uploaded.',
  keywords: [
    ...
    'best json beautifier online',
  ],
  openGraph: {
    title: 'Free JSON Beautifier & Formatter — View, Validate, JSONPath & TypeScript Online | UnblockDevs',
    description:
      'Format, beautify, validate, and explore JSON with tree view, JSONPath queries, TypeScript interface generator, and SQL export. 100% client-side — nothing sent to servers. No signup.',
    type: 'website',
    url: canonicalUrl,
  ...
  twitter: {
    ...
    title: 'Free JSON Beautifier & Formatter — View, Validate & Explore Online',
    description: 'Format, beautify, validate, tree view, JSONPath, TypeScript generator, SQL export. 100% in your browser — nothing uploaded.',
  },
